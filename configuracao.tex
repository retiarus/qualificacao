...
\titulo{Análise da correlação entre índice de cintilação e o conteúdo eletronico total da ionosfera no pico da anomalia magnética.}
...
\descriccao{Monografia para Exame de Qualificação do Curso de Pós-Graduação em Computação Aplicada, orientada pelo Dr. Stephan Stephany, aprovada em 11 de dezembro de 2018.}
